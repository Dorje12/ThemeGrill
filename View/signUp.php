...
<body>
<div class="container">
    <form method="POST" action="processRegistration.php" enctype="multipart/form-data"> <!-- Add 'enctype' attribute for file upload -->
        ...
        <button type="submit" class="btn btn-primary">Submit</button><a href="login.php">Already have an account</a>
    </form>
</div>
</body>
</html>
