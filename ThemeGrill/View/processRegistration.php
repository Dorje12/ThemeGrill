...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $position = validateInput($_POST['position']); // Corrected the typo in the variable name
...
{
    $targetDir = "uploads/"; // Create a folder named 'uploads' in the same directory as your PHP files
